  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-linear-to-b from-[#05ADE8] to-[#6CCCC8] px-5 font-bold text-white disabled:opacity-60"
      >
        <Plus size={20} />
        {uploading ? "جاري الرفع..." : "أضف ملف جديد"}
      </button>
    </>
  );
}
