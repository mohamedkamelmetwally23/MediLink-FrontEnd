...
export const arrowButtonClass =
  "inline-grid h-8 w-8 shrink-0 place-items-center rounded-full dark:bg-[#3d3d3d] text-[#05ADE8] shadow-sm transition hover:bg-[#4a4a4a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#05ADE8] disabled:cursor-not-allowed disabled:opacity-40";
