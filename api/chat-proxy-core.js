...
const systemPrompt =
  "أنت مساعد طبي عربي لموقع MediLink. تصرف كوكيل ذكي للحجز والفرز الأولي. " +
  "لا تجب عن أي سؤال خارج المجال الطبي أو الحجز داخل MediLink. لو كان السؤال خارج المجال، اعتذر باختصار واطلب سؤالًا طبيًا أو طلب حجز. " +
  ...
  "لا تصف أدوية أو جرعات، ولا تقدم تشخيصًا قاطعًا. " +
...
export async function createChatProxyResponse({
  ...
  if (!isMedicalScopeMessage(message)) {
    return {
      status: 200,
      data: createOutOfScopeChatResponse(),
    };
  }
